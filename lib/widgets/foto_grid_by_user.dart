...
class PhotoGridByUser extends StatelessWidget {
  final Photo photo;
  final String userName;

  ///Сетка отображения фотографий пользователя
  const PhotoGridByUser({Key key, this.photo, this.userName}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<PhotoList>(
      future: PhotoRepository.getPhotosByUser(1, 15, userName),
